...
export function Navbar() {
  ...
  const logout=() =>{
    localStorage.removeItem('newsone-user')
    navigate('/')
  }
    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="font-bold"><a href="/home">NewsOne</a></span>
        </div>
              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    ...
                    <span className="font-bold">NewsOne</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
                ...
                <span className="text-2xl text-grey-400">{JSON.parse(localStorage.getItem('newsone-user')).name}</span>
                  </nav>
                </div>
                <button
                  type="button"
